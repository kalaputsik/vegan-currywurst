...
use Spryker\Zed\DiscountPromotion\Communication\Plugin\Cart\NonSplittablePromotionProductItemExpanderPlugin;
...
class CartDependencyProvider extends SprykerCartDependencyProvider
{
    ...
    protected function getExpanderPlugins(Container $container): array
    {
        return [
            ...
            new NonSplittablePromotionProductItemExpanderPlugin(),
        ];
    }
