...
use Spryker\Zed\StoreReference\Communication\Plugin\StoreReferenceAccessTokenRequestExpanderPlugin;
...
class OauthClientDependencyProvider extends SprykerOauthClientDependencyProvider
{
    ...
    {
        return [
            new StoreReferenceAccessTokenRequestExpanderPlugin(), new StoreReferenceAccessTokenRequestExpanderPlugin(),
        ];
    }
}
